  ...
  <section class="services-body cat">
    ...
    <section class="services-container mx-5">
      <div class="services-nav py-1">
        <a class="nav-link active my-1" aria-current="page" href="services cat pet care.html">Pet Care</a>
        <a class="nav-link my-1" aria-current="page" href="services cat emergency care.html">Emergency Care</a>
      </div>
      <div class="services-nav mt-2 py-1">
        <a class="nav-link my-1" aria-current="page" href="services dog pet care.html">For Dogs</a>
        <a class="nav-link active my-1" aria-current="page" href="services cat pet care.html">For Cats</a>
      </div>
    </section>
