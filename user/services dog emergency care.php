...
<body>
  ...
  <section class="services-body">
    ...
    <section class="pet-care-dogs my-3 py-5 px-5">
      ...
      <h1>Emergency Care Services for Dogs</h1>
      <div class="col mt-3">
        <div class="card my-3" style="width: 18rem;">
          <img class="card-img-top" src="../img/triage.png_-_en" alt="Our Services">
          <div class="card-body">
            <h5 class="card-title">Triage and Assessment</h5>
            <p class="card-text">Quickly evaluate the dog's condition and prioritize based on urgency.</p>
        ...
        <div class="card my-3" style="width: 18rem;">
          ...
          <div class="card-body">
            <h5 class="card-title">Trauma Care</h5>
      ...
      <div class="col mt-3">
        <div class="card my-3">
          <img class="card-img-top" src="../img/poisoning.jpg" alt="Our Vets">
          <div class="card-body">
            <h5 class="card-title">Poisoning and Toxin Exposure</h5>
            <p class="card-text">Immediate care for dogs that have ingested toxic substances.</p>
            <p><a href="../users/clinic-facilities.php">View Facilities</a></p>
            <h5>₱100</h5>
            <a href="#" class="btn px-3 py-2">Call for Help</a>
          </div>
      ...
      <div class="col mt-3">
        <div class="card my-3" style="width: 18rem;">
          <img class="card-img-top" src="../img/fptp_heatstroke-42421-article.png_-_en" alt="Clinic Facilities">
          <div class="card-body">
            <h5 class="card-title">Heatstroke and Hypothermia Treatment</h5>
            <p class="card-text">Immediate treatment for dogs suffering from these.</p>
            <p><a href="../users/clinic-facilities.php">View Facilities</a></p>
            <h5>₱350</h5>
            <a href="#" class="btn px-3 py-2">Call for Help</a>
          </div>
      ...
      <div class="col mt-3">
        <div class="card my-3" style="width: 18rem;">
          <img class="card-img-top" src="../img/parvo.webp" alt="Contact Us">
          <div class="card-body">
            <h5 class="card-title">Infectious Disease</h5>
            <p class="card-text">Treating dogs with severe infectious diseases like parvovirus or leptospirosis.</p>
            <p><a href="../users/clinic-facilities.php">View Facilities</a></p>
            <h5>₱500</h5>
            <a href="#" class="btn px-3 py-2">Call for Help</a>
          </div>
